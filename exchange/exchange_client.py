...
class ExchangeClient:
    ...
    async def watch_order_book(self):
        async with websockets.connect("wss://stream.binance.com:9443/ws/ethusdt@depth") as ws:
    ...
    def call_API(self, name: str, fn: Callable) -> T:
        ...
        try:
            res = fn()
            weight = int(self.exchange.last_response_headers.get(
    ...
    def fetch_order_book(
        self,
        symbol: str,       # "ETH/USDT"
        limit: int = 20    # Number of price levels
    ) -> OrderBook:
        """
        ...
        return_order_book = OrderBook(
            symbol, order_book.timestamp, order_book.bids[:limit], order_book.asks[:limit])
    ...
    def fetch_balance(self) -> dict[str, dict]:
        ...
        """
        result = self.call_API("fetchBalance",
    ...
    def create_limit_ioc_order(
        ...
        """
        cctx_order = self.call_API("createLimitOrder",
    ...
    def create_market_order(self, symbol: str, side: str, amount: float,) -> dict:
        ...
        """
        cctx_order = self.call_API("createMarketOrder",
    ...
    def cancel_order(self, order_id: str, symbol: str) -> dict:
        ...
        cctx_order = self.call_API("cancelOrder",
    ...
    def fetch_order_status(self, order_id: str, symbol: str) -> dict:
        ...
        order_status = self.call_API("fetchOrderStatus",
                                     lambda: self.exchange.fetch_order_status(
                                         order_id, symbol),
                                     )
        return order_status
    ...
    def get_trading_fees(self, symbol: str) -> dict:
        ...
        """
        fees = self.call_API("fetchTradingFees",
